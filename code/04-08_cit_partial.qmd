 ...
 **Avoids Multicollinearity due to binary splits (no multivar analysis)**
...
In the algorithm below, we are asking for 50 iterations.  **100 is better**
...
# Summary  
In this exercise, we covered:  (this will be on exam/final)
